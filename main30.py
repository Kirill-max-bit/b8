...
max_number = max(num for num, div in numbers_with_divisors if div == max_divisor_count)
print("а) Максимальное число:", max_number)

# б) Минимальное число с максимальным количеством делителей
min_number = min(num for num, div in numbers_with_divisors if div == max_divisor_count)
